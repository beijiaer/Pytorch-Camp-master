...
path_lenet = os.path.join(BASE_DIR, "hello pytorch", "model", "lenet.py")
path_tools = os.path.join(BASE_DIR, "hello pytorch", "tools", "common_tools.py")
assert os.path.exists(path_lenet), "{}不存在，请将lenet.py文件放到 {}".format(path_lenet, os.path.dirname(path_lenet))
assert os.path.exists(path_tools), "{}不存在，请将common_tools.py文件放到 {}".format(path_tools, os.path.dirname(path_tools))
import sys
hello_pytorch_DIR = os.path.abspath(os.path.join(BASE_DIR,'hello pytorch'))
...
#split_dir = ''
    # os.path.join(BASE_DIR, "..", "..", "da ta", "rmb_split")
...
valid_transform = transforms.Compose([
    transforms.Resize((32, 32)),#验证模型的时候不需要数据增强
    transforms.ToTensor(),
